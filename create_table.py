...
cursor.execute("CREATE TABLE IF NOT EXISTS bookings (booking_id INTEGER PRIMARY KEY, courses text, user_id INTEGER, date TEXT, time TEXT, FOREIGN KEY(user_id) REFERENCES users(id))")
connection.commit()
